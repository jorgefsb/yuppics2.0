...
class my_paypal{
	...
	function __construct($conf_sale=array(), $conf_payment=array() ){
		$this->PayPalConfig = array('Sandbox' => $sandbox, 'APIUsername' => $api_username, 'APIPassword' => $api_password, 'APISignature' => $api_signature);
	...
	public function add_products($product){
		...
		array_push($this->Payment['order_items'], $PaymentOrderItems);
	}
